...
function buildAnalysisSummary({ templateSource, detected, inferred, pages, relevantPages, modules, extraction, estimatedPages }) {
  ...
  return {
    ...
    structureStrategy: extraction.status === "text-extracted"
    ...
    criticalConcepts,
    warnings: [
      ...(extraction.status !== "text-extracted" ? ["O PDF parece ter pouco texto selecionavel; o treinamento foi criado com mais apoio do template."] : []),
